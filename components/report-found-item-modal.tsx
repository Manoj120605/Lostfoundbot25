...
interface ReportFoundItemModalProps {
  isOpen: boolean
  onClose: () => void
}
...
export default function ReportFoundItemModal({ isOpen, onClose }: ReportFoundItemModalProps) {
    ...
    <Dialog open={isOpen} onOpenChange={(open) => !open && handleClose()}>
      <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>Fill out the form below to report an item you've found.</DialogDescription>
        </DialogHeader>

        <div className="py-4">
          <h2 className="text-xl font-semibold mb-6">Found Item Report</h2>
          ...
          {step === 2 && (
            <div className="space-y-4">
              <h3 className="text-lg font-medium mb-4">Where did you find the item?</h3>
          ...
          {step === 3 && (
            <div className="space-y-4">
              <h3 className="text-lg font-medium mb-4">When did you find the item?</h3>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  onChange={(e) => setItemDetails({ ...itemDetails, description: e.target.value })}
                  placeholder="Describe any distinguishing features, markings, etc."
                  rows={4}
                  required
                />
              </div>
